        ...
        .factory('$cordovaDeviceMotion', ['$q', function ($q) {
            ...
            return {
                getCurrentAcceleration: function () {
                    ...
                    if (angular.isUndefined(navigato.accelerometer) || !angular.isFunction(navigator.accelerometer.getCurrentAcceleration)) {
                ...
                watchAcceleration: function (options) {
                    ...
                    if (angular.isUndefined(navigato.accelerometer) || !angular.isFunction(navigator.accelerometer.watchAcceleration)) {
                        q.reject('Device do not support watchAcceleration');
                    }
