angular.module("ngMap", []), function () {
    ...
    var SPECIAL_CHARS_REGEXP = /([\:\-\_]+(.))/g, MOZ_HACK_REGEXP = /^moz([A-Z])/, Attr2Options = function ($parse, $timeout, NavigatorGeolocation, GeoCoder) {
        var orgAttributes = function (e) {
            ...
            try {
                ...
                try {
                    ...
                    } else output === Object(output) && (output = getOptions(output, options))
                } catch (err2) {
                    if (input.match(/^[A-Z][a-zA-Z0-9]+\(.*\)$/))try {
                        ...
                        output = input
                    } else if (input.match(/\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/))try {
            ...
            for (var o in e)if (e[o]) {
                ...
                n[o] = "string" != typeof e[o] ? e[o] : toOptionValue(e[o], {scope: t, key: o})
            }
            return n
                ...
                try {
                    ...
                    for (var a in r)if (r[a]) {
                        ...
                        if ("string" == typeof s ? s = s.toUpperCase() : "mapTypeIds" === a && (s = s.map(function (e) {
                            ...
                            var c = n.charAt(0).toUpperCase() + n.slice(1), u = c.replace(/Options$/, "") + "Style";
                            r[a] = google.maps[u][s]
        ...
        return{camelCase: camelCase, filter: filter, getOptions: getOptions, getEvents: getEvents, getControlOptions: getControlOptions, toOptionValue: toOptionValue, getAttrsToObserve: getAttrsToObserve, orgAttributes: orgAttributes}
    };
    Attr2Options.$inject = ["$parse", "$timeout", "NavigatorGeolocation", "GeoCoder"], angular.module("ngMap").service("Attr2Options", Attr2Options)
}(), function () {
    "use strict";
    var e = function (e) {
        return{geocode: function (t) {
    ...
    "use strict";
    angular.module("ngMap").directive("bicyclingLayer", ["Attr2Options", function (e) {
        var t = e, n = function (e, t) {
            var n = new google.maps.BicyclingLayer(e);
            for (var o in t)google.maps.event.addListener(n, o, t[o]);
            return n
        };
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.orgAttributes(o), s = t.filter(i), c = t.getOptions(s), u = t.getEvents(e, s), l = n(c, u);
            r.addObject("bicyclingLayers", l), r.observeAttrSetObj(a, i, l), o.bind("$destroy", function () {
                r.deleteObject("bicyclingLayers", l)
            })
        }}
    }])
}(), function () {
    "use strict";
    angular.module("ngMap").directive("cloudLayer", ["Attr2Options", function (e) {
        var t = e, n = function (e, t) {
        ...
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.orgAttributes(o), s = t.filter(i), c = t.getOptions(s), u = t.getEvents(e, s), l = n(c, u);
            r.addObject("cloudLayers", l), r.observeAttrSetObj(a, i, l), o.bind("$destroy", function () {
                r.deleteObject("cloudLayers", l)
            })
        }}
    }])
}(), function () {
    "use strict";
    angular.module("ngMap").directive("customControl", ["Attr2Options", "$compile", function (e, t) {
        var n = e;
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = (n.orgAttributes(o), n.filter(i)), s = n.getOptions(a, e), c = n.getEvents(e, a), u = o[0].parentElement.removeChild(o[0]);
            t(u.innerHTML.trim())(e);
            for (var l in c)google.maps.event.addDomListener(u, l, c[l]);
            r.addObject("customControls", u), e.$on("mapInitialized", function (e, t) {
                var n = s.position;
    ...
    var e, t, n, o = function (e) {
        ...
        o.prototype = new google.maps.OverlayView, o.prototype.setContent = function (e, o) {
            if (this.html = e, o) {
                var i = t(e)(o), r = i[0], a = this;
                n(function () {
                    a.content = r.innerHTML, a.el.innerHTML = a.content
                })
            } else this.content = e, this.el.innerHTML = this.content;
            this.el.style.position = "relative", this.el.className = "custom-marker"
        ...
        return e = r, t = a, n = s, i(), {restrict: "E", require: "^map", link: function (t, n, i, r) {
            var a = (e.orgAttributes(n), e.filter(i)), s = e.getOptions(a, t), c = e.getEvents(t, a), u = n[0].parentElement.removeChild(n[0]), l = new o(s);
            l.setContent(u.innerHTML, t);
            for (var p in c)google.maps.event.addDomListener(l.el, p, c[p]);
            r.addObject("customMarkers", l), s.position instanceof google.maps.LatLng || r.getGeoLocation(s.position).then(function (e) {
                l.setPosition(e)
            }), n.bind("$destroy", function () {
                r.deleteObject("customMarkers", marker)
            })
        }}
    };
    r.$inject = ["Attr2Options", "$compile", "$timeout"], angular.module("ngMap").directive("customMarker", r)
}(), function () {
    "use strict";
    var e = function (e, t) {
        ...
        var i = t, r = new google.maps.DirectionsService, a = function (e, t) {
            var i = t;
            ...
            var c = function (t) {
                r.route(t, function (t, o) {
                    o == google.maps.DirectionsStatus.OK && n(function () {
                        e.setDirections(t)
                    })
                })
            };
            i.origin && i.destination && ("current-location" == i.origin ? o.getCurrentPosition().then(function (e) {
                i.origin = new google.maps.LatLng(e.coords.latitude, e.coords.longitude), c(i)
            }) : "current-location" == i.destination ? o.getCurrentPosition().then(function (e) {
                i.destination = new google.maps.LatLng(e.coords.latitude, e.coords.longitude), c(i)
            }) : c(i))
        }, s = function (t, o, r, s) {
            var c = i.orgAttributes(o), u = i.filter(r), l = i.getOptions(u), p = i.getEvents(t, u), g = i.getAttrsToObserve(c), d = e(l, p);
            s.addObject("directionsRenderers", d), g.forEach(function (e) {
                !function (e) {
                    r.$observe(e, function (t) {
                        if ("panel" == e)n(function () {
                            var e = document.getElementById(t) || document.querySelector(t);
                            e && d.setPanel(e)
                        }); else if (l[e] !== t) {
                            var o = i.toOptionValue(t, {key: e});
                            l[e] = o, a(d, l)
                        }
                    })
                }(e)
                ...
                s.deleteObject("directionsRenderers", d)
            })
        };
    ...
    angular.module("ngMap").directive("dynamicMapsEngineLayer", ["Attr2Options", function (e) {
        ...
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.filter(i), s = t.getOptions(a), c = t.getEvents(e, a, c), u = n(s, c);
            r.addObject("mapsEngineLayers", u)
        }}
    }])
}(), function () {
    "use strict";
    angular.module("ngMap").directive("fusionTablesLayer", ["Attr2Options", function (e) {
        var t = e, n = function (e, t) {
        ...
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.filter(i), s = t.getOptions(a), c = t.getEvents(e, a, c), u = n(s, c);
            r.addObject("fusionTablesLayers", u)
        }}
    }])
}(), function () {
    "use strict";
    angular.module("ngMap").directive("heatmapLayer", ["Attr2Options", "$window", function (e, t) {
        var n = e;
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            ...
            r.addObject("heatmapLayers", c)
        }}
    }])
}(), function () {
    "use strict";
    var e = function (e, t, n, o) {
        var i = e, r = function (e, o, i) {
            var r;
            ...
            return r.__template = s.replace(/\s?ng-non-bindable[='"]+/, ""), r.__compile = function (e, n) {
                n && (e["this"] = n);
                var o = t(r.__template)(e);
                r.setContent(o[0]), e.$apply()
            }, r.__open = function (e, t, o) {
                n(function () {
                    r.__compile(t, o), o && o.getPosition ? r.open(e, o) : o && o instanceof google.maps.LatLng ? (r.open(e), r.setPosition(o)) : r.open(e)
                })
            }, r
        }, a = function (e, t, n, a) {
            t.css("display", "none");
            var s, c = i.orgAttributes(t), u = i.filter(n), l = i.getOptions(u, e), p = i.getEvents(e, u);
            ...
            s && a.getGeoLocation(s).then(function (t) {
                ...
                var i = a.map.infoWindows[n], r = o ? o : this.getPosition ? this : null;
                i.__open(a.map, e, r)
    ...
    "use strict";
    angular.module("ngMap").directive("kmlLayer", ["Attr2Options", function (e) {
        var t = e, n = function (e, t) {
        ...
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.orgAttributes(o), s = t.filter(i), c = t.getOptions(s), u = t.getEvents(e, s), l = n(c, u);
            r.addObject("kmlLayers", l), r.observeAttrSetObj(a, i, l), o.bind("$destroy", function () {
                r.deleteObject("kmlLayers", l)
            })
        }}
    }])
}(), function () {
    "use strict";
    angular.module("ngMap").directive("mapData", ["Attr2Options", function (e) {
        var t = e;
        return{restrict: "E", require: "^map", link: function (e, n, o) {
            var i = t.filter(o), r = t.getOptions(i), a = t.getEvents(e, i, a);
            e.$on("mapInitialized", function (t, n) {
                for (var o in r)if (o) {
                    var i = r[o];
                    "function" == typeof e[i] ? n.data[o](e[i]) : n.data[o](i)
                }
    ...
    angular.module("ngMap").directive("mapType", ["Attr2Options", "$window", function (e, t) {
        return{restrict: "E", require: "^map", link: function (e, n, o, i) {
            ...
            if (o.object) {
                ...
                r = s[o.object], "function" == typeof r && (r = new r)
            }
            if (!r)throw"invalid map-type object";
            e.$on("mapInitialized", function (e, t) {
                t.mapTypes.set(a, r)
            }), i.addObject("mapTypes", r)
        }}
    }])
}(), function () {
    "use strict";
    ...
    var t = function (t, n, o) {
        var i = t, r = function (t, r, a, s) {
            var c = i.orgAttributes(r);
            t.google = google;
            var u = document.createElement("div");
            u.style.width = "100%", u.style.height = "100%", r.prepend(u), "false" !== a.defaultStyle && ("block" != e(r[0], "display") && r.css("display", "block"), e(r[0], "height").match(/^(0|auto)/) && r.css("height", "300px")), r[0].addEventListener("dragstart", function (e) {
                return e.preventDefault(), !1
            });
            var l = function (e, i) {
                var r = new google.maps.Map(u, {});
                r.markers = {}, r.shapes = {}, n(function () {
                ...
                l ? l instanceof google.maps.LatLng || (delete e.center, s.getGeoLocation(l).then(function (e) {
                    ...
                    r.setCenter(g.geoFallbackCenter)
                })) : e.center = new google.maps.LatLng(0, 0), r.setOptions(e);
                for (var p in i)p && google.maps.event.addListener(r, p, i[p]);
                s.observeAttrSetObj(c, a, r), s.map = r, s.addObjects(s._objects), t.map = r, t.map.scope = t, google.maps.event.addListenerOnce(r, "idle", function () {
                    t.$emit("mapInitialized", r), a.zoomToIncludeMarkers && (s.zoomToIncludeMarkers(), "auto" == a.zoomToIncludeMarkers && t.$on("objectChanged", function (e, t) {
                        "markers" == t[0] && s.zoomToIncludeMarkers()
                    }))
                })
            }, p = i.filter(a), g = i.getOptions(p, t), d = i.getControlOptions(p), f = angular.extend(g, d), m = i.getEvents(t, p);
            a.initEvent ? t.$on(a.initEvent, function () {
                !s.map && l(f, m)
            }) : l(f, m)
        };
        return{restrict: "AE", controller: "MapController", link: r}
    };
    ...
    var e = function (e, t, n, o, i) {
        var r = i, a = this, s = function (e, t, n) {
            e.$observe(t, function (e) {
                if (e) {
                    var o = r.camelCase("set-" + t), i = r.toOptionValue(e, {key: t});
                    n[o] && (t.match(/center|position/) && "string" == typeof i ? a.getGeoLocation(i).then(function (e) {
                        n[o](e)
                    }) : n[o](i))
                }
            })
        ...
        this.map = null, this._objects = [], this.addObject = function (t, n) {
            ...
            if (n.map) {
                var o = n.map[t];
                for (var i in o)o[i] === n && delete o[i];
            ...
            return!e || e.match(/^current/i) ? n.getCurrentPosition().then(function (e) {
                ...
                i.reject(e)
            }) : o.geocode({address: e}).then(function (e) {
            ...
            for (var i = 0; i < o.length; i++)s(t, o[i], n)
    ...
    "use strict";
    angular.module("ngMap").directive("mapsEngineLayer", ["Attr2Options", function (e) {
        var t = e, n = function (e, t) {
    ...
    var e = function (e, t) {
        ...
        if (e.icon instanceof Object) {
            ...
            for (var o in e.icon) {
                var i = e.icon[o];
                "anchor" == o || "origin" == o ? e.icon[o] = new google.maps.Point(i[0], i[1]) : ("size" == o || "scaledSize" == o) && (e.icon[o] = new google.maps.Size(i[0], i[1]))
            }
        }
        ...
        var o = t, i = function (t, i, r, a) {
            var s, c = o.orgAttributes(i), u = o.filter(r), l = o.getOptions(u, t), p = o.getEvents(t, u);
            ...
            a.addObject("markers", g), s && a.getGeoLocation(s).then(function (e) {
                ...
                var o = r.geoCallback;
                o && n(o)(t)
            }), a.observeAttrSetObj(c, r, g), i.bind("$destroy", function () {
                a.deleteObject("markers", g)
            })
        };
        return{restrict: "E", require: "^map", link: i}
    };
    t.$inject = ["Attr2Options", "$parse"], angular.module("ngMap").directive("marker", t)
}(), function () {
    "use strict";
    angular.module("ngMap").directive("overlayMapType", ["Attr2Options", "$window", function (e, t) {
        return{restrict: "E", require: "^map", link: function (e, n, o, i) {
            var r, a = o.initMethod || "insertAt";
            if (o.object) {
                var s = e[o.object] ? e : t;
                r = s[o.object], "function" == typeof r && (r = new r)
            }
            ...
            e.$on("mapInitialized", function (e, t) {
                if ("insertAt" == a) {
                    ...
                    t.overlayMapTypes.insertAt(n, r)
                } else"push" == a && t.overlayMapTypes.push(r)
    ...
    var e = function (e, t) {
        var n = e, o = function (e, o, i, r) {
            var a = n.filter(i), s = n.getOptions(a), c = n.getEvents(e, a), u = new google.maps.places.Autocomplete(o[0], s);
            for (var l in c)google.maps.event.addListener(u, l, c[l]);
            var p = function () {
                t(function () {
            ...
            google.maps.event.addListener(u, "place_changed", p), o[0].addEventListener("change", p), i.$observe("types", function (e) {
                if (e) {
    ...
    var e = function (e) {
        ...
        var o, i = t.name;
        if (delete t.name, t.icons)for (var r = 0; r < t.icons.length; r++) {
            var a = t.icons[r];
        ...
        switch (i) {
            ...
            case"groundOverlay":
            case"image":
                var s = t.url, c = e(t.bounds), u = {opacity: t.opacity, clickable: t.clickable, id: t.id};
                o = new google.maps.GroundOverlay(s, c, u)
        }
        for (var l in n)n[l] && google.maps.event.addListener(o, l, n[l]);
        return o
    }, n = function (e, n) {
        var o = e, i = function (e, i, r, a) {
            var s, c, u = o.orgAttributes(i), l = o.filter(r), p = o.getOptions(l), g = o.getEvents(e, l);
            ...
            a.addObject("shapes", d), s && "circle" == c && a.getGeoLocation(s).then(function (t) {
                ...
                var o = r.geoCallback;
                o && n(o)(e)
            }), a.observeAttrSetObj(u, r, d), i.bind("$destroy", function () {
    ...
    var e = function (e) {
        var t = e, n = function (e, t, n) {
            ...
            e.$on("mapInitialized", function (e, t) {
                ...
                var i = google.maps.event.addListener(t, "center_changed", function () {
                    o.setPosition(t.getCenter()), google.maps.event.removeListener(i)
                })
            })
        };
    ...
    "use strict";
    angular.module("ngMap").directive("trafficLayer", ["Attr2Options", function (e) {
        var t = e, n = function (e, t) {
        ...
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.orgAttributes(o), s = t.filter(i), c = t.getOptions(s), u = t.getEvents(e, s), l = n(c, u);
            r.addObject("trafficLayers", l), r.observeAttrSetObj(a, i, l), o.bind("$destroy", function () {
                r.deleteObject("trafficLayers", l)
            })
        }}
    }])
}(), function () {
    ...
    angular.module("ngMap").directive("transitLayer", ["Attr2Options", function (e) {
        ...
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.orgAttributes(o), s = t.filter(i), c = t.getOptions(s), u = t.getEvents(e, s), l = n(c, u);
            r.addObject("transitLayers", l), r.observeAttrSetObj(a, i, l), o.bind("$destroy", function () {
                r.deleteObject("transitLayers", l)
            })
        }}
    }])
}(), function () {
    ...
    angular.module("ngMap").directive("weatherLayer", ["Attr2Options", function (e) {
        ...
        return{restrict: "E", require: "^map", link: function (e, o, i, r) {
            var a = t.orgAttributes(o), s = t.filter(i), c = t.getOptions(s), u = t.getEvents(e, s), l = n(c, u);
            r.addObject("weatherLayers", l), r.observeAttrSetObj(a, i, l), o.bind("$destroy", function () {
                r.deleteObject("weatherLayers", l)
            })
        }}
    }])
}();